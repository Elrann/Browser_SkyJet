...
<link rel="stylesheet" type="text/css" href="css/main/base.old.min.css?v1015"><link rel="stylesheet" type="text/css" href="css/jquery.mCustomScrollbar.min.css">
            ...
            <div class="container">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="http://professorweb.ru/forum">Форум</a></li>
                    </ul>
                </nav>
            </div>
        </div>
...
Основная цель WPF состоит в интеграции и унификации множества ранее разрозненных настольных технологий (двух- и трехмерная графика, разработка окон и элементов управления и т.п.) в единую унифицированную программную модель.</p>
                   <ul>
        			...
        			<div class="container">
                    	<h2><a href="http://professorweb.ru/forum/">Форум программистов .NET</a></h2>
               			<p>Компьютерный форум для начинающих и опытных программистов, использующих среду разработки .NET.</p>
               			<ul>
                  			<li><a href="http://professorweb.ru/forum/conversations/wpf">WPF</a></li>
                  			<li><a href="http://professorweb.ru/forum/conversations/c-sharp">Язык C#</a></li>
                  			<li><a href="http://professorweb.ru/forum/conversations/silverlight">Silverlight</a></li>
                  			<li><a href="http://professorweb.ru/forum/conversations/expression-blend">Expression Blend</a></li>
              			</ul>
               			<ul>
                 			<li><a href="http://professorweb.ru/forum/conversations/asp-net">ASP.NET</a></li>
                  			<li><a href="http://professorweb.ru/forum/conversations/ado-net">ADO.NET</a></li>
                  			<li><a href="http://professorweb.ru/forum/conversations/net">Периферия .NET</a></li>
                  			<li><a href="http://professorweb.ru/forum/conversations/qs">Вопросы по сайту</a></li>
               			</ul>
                    </div>
        		</div>
...
<div class="container">                
			...
			<footer>
				<p>Alexandr Erohin &#10031; alexerohinzzz@gmail.com &copy; 2011 - 2015</p>
			</footer>
		</div>
	</div>
</div>
